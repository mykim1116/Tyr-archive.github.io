...
const getJapaneseSubtitle = (text: string): string => {
  const dict: Record<string, string> = {
    // b2-v1 subtitles
    '셰티르: "정문으로 안전하게 빠져나가자니까, 라스!"': 'セティル「正面から安全に抜け出そうって、ラス！」',
    '라스: "정문 돌파 시 지연 시간 245초. 비효율적."': 'ラス「正面突破時、遅延時間245秒。非効率的。」',
    '셰티르: "설마 또... 아냐, 그 창문은 안 돼!"': 'セティル「まさか、また…いや、その窓はダメ！」',
    '라스: "인력 낙하 개시. 유리창 파열 격차 3, 2, 1."': 'ラス「引力落下開始。ガラス窓破裂偏差3, 2, 1。」',
    '셰티르: "야! 여긴 지상 4층이란 말이야!"': 'セティル「ちょっと！ここは地上4階なんだよ！」',
    '라스: "착지하면 곧바로 1층. 탈출 경로 계산 종료."': 'ラス「着地すれば直ちに1階。脱出経路計算終了。」',

    // b2-v2 subtitles
    "셰티르: '학림 사람들은 저를 고립된 배척의 시선으로 보지만...'": 'セティル「学林の人々は僕を疎外された視線で見つめますが…」',
    "셰티르: '제 날개 끝에서 현현하는 이 황금빛 마네의 주파수는 세상에서 가장 따스해요.'": 'セティル「でも、僕の羽の先で顕現するこの黄金のマナの周波数は、世界で一番温かいです。」',
    "시스템: '수리부엉이 청각 동기화 검출. 무성음 영창 파동 [Tipon] 동조 완료.'": 'システム「ミミズク聴覚同期検出。無声音詠唱波動【ティポン】同調完了」',
    "셰티르: '들려요... 이 정교한 진동 너머 가변지대 속에서 우릴 기다리는 가슴 벅찬 침묵들이.'": 'セティル「聞こえます…この精巧な振動の先、可変地帯の中で僕たちを待つ胸高鳴る沈黙たちが。」',
    ...
    '루미나: "여기 있습니다만, 캔 오프너가 고장 났습니다."': 'ルミナ「ここにありますが、缶切りが故障しております。」',
    '에티야: "그럼 어떻게 열라는... 잠깐만, 손으로?!"': 'エティヤ「じゃあどうやって開けるの…ちょっと、手で？！」',
    '루미나: "콰직! (맨손으로 캔을 파쇄해 내용물을 쏟아냄)"': 'ルミナ「クワジッ！（素手で缶を粉砕して中身をぶちまける）」',
    '에티야: "...이걸 먹으라고 준 거야, 아니면 머리에 피도 안 마른 애 장난이야?"': 'エティヤ「…これを食べろとくれたの、それとも頭の青いガキのイタズラ？」',
    '루미나: "최선을 다했습니다!"': 'ルミナ「最善を尽くしました！」',

    // b3-v2 subtitles
    '제국 인사: "황실 생존자 에티야 공주님이시군요. 협상에 응하십시오."': '帝国人士「皇室の生存者エティヤ王女様ですね。交渉に応じなさい。」',
    '에티야: "당신들의 제안은 단순한 협박일 뿐이에요."': 'エティヤ「あなたたちの提案は単純な脅迫に過ぎません。」',
    '루미나: "공주님, 뒤로 물러서십시오. 장막 마법 장벽을 전개합니다."': 'ルミナ「王女様、お下がりください。帳魔法障壁を展開します。」',
    '시스템: "장막 배리어 필드 활성화 완료. 외부 영창 역탐지 보정 장치 가동."': 'システム「帳バリアフィールド活性化完了。外部詠唱逆探知補正装置稼働」',
    '제국 인사: "말도 안 돼! 우리 마도 신호가 전혀 닿지 않아...!"': '帝国人士「あり得ない！我々の魔導信号が全く届かない…！」',
    '에티야: "이게 우리의 대답이에요."': 'エティヤ「これが私たちの答えです。」'
  };
  ...
  const b2Videos = [
    {
      ...
      duration: 15,
      subtitles: [
        { time: 0, text: '셰티르: "정문으로 안전하게 빠져나가자니까, 라스!"', speaker: "셰티르" },
        { time: 3, text: '라스: "정문 돌파 시 지연 시간 245초. 비효율적."', speaker: "라스" },
        { time: 6, text: '셰티르: "설마 또... 아냐, 그 창문은 안 돼!"', speaker: "셰티르" },
        { time: 9, text: '라스: "인력 낙하 개시. 유리창 파열 격차 3, 2, 1."', speaker: "라스" },
        { time: 12, text: '셰티르: "야! 여긴 지상 4층이란 말이야!"', speaker: "셰티르" },
        { time: 15, text: '라스: "착지하면 곧바로 1층. 탈출 경로 계산 종료."', speaker: "라스" }
      ],
      initialComments: []
    },
    {
      id: "b2-v2",
      title: "캐릭터 트레일러 | 셰티르 - 황금빛 마네 🦉",
      sub: "소리굽쇠 수명 합리 // 셰티르 극비 시퀀스",
      desc: "라리스 아카데미아의 폐쇄된 비밀 화원. 셰티르 원화를 고화질로 덧씌워, 따뜻하면서도 고고한 황금빛 마구(Manes) 에너지가 날개 끝에서 부유해 밤을 밝히는 은밀한 순간을 감동적으로 연출한 숏무비입니다.",
      character: "셰티르",
      avatar: "/src/assets/images/shetyr_cover_art_1780299676615.png",
      coverImage: "/src/assets/images/shetyr_cover_art_1780299676615.png",
      isAmberTheme: true,
      duration: 15,
      subtitles: [
        { time: 0, text: "셰티르: '학림 사람들은 저를 고립된 배척의 시선으로 보지만...'", speaker: "셰티르" },
        { time: 3, text: "셰티르: '제 날개 끝에서 현현하는 이 황금빛 마네의 주파수는 세상에서 가장 따스해요.'", speaker: "셰티르" },
        { time: 6, text: "시스템: '수리부엉이 청각 동기화 검출. 무성음 영창 파동 [Tipon] 동조 완료.'", speaker: "시스템" },
        { time: 9, text: "셰티르: '들려요... 이 정교한 진동 너머 가변지대 속에서 우릴 기다리는 가슴 벅찬 침묵들이.'", speaker: "셰티르" },
        { time: 12, text: "셰티르: '편지를 발송한 사람을 마주하는 그 날까지, 이 날갯짓의 울림은 멈추지 않아요.'", speaker: "셰티르" }
      ],
      initialComments: []
    },
    {
